                    ...
                    <div class="col-xl-10 col-lg-10 col-md-10">
                        <div class="menu-main d-flex align-items-center justify-content-end">
                            ...
                            <div class="header-right-btn f-right d-none d-lg-block ml-30">
                                <a href="login.php" class="btn header-btn">Log In</a>
                            </div>
                        </div>
                    </div>   
                    <div class="col-12">
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="home-blog-single mb-30">
                        <div class="blog-img-cap">
                            <div class="blog-img">
                                <a href="events.php"><img src="blog_3.png" alt="" height="600px" width="600px"></a>
                            </div>
                            <div class="blog-cap">
                                <h3><a href="events.php">Little Akiba, Event Cosplay & Entertainment</a></h3>
                                <a href="events.php" class="more-btn">Read more »</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="home-blog-single mb-30">
                        <div class="blog-img-cap">
                            <div class="blog-img">
                            <a href="events.php"><img src="single_blog_3.png" alt="" height="600px" width="600px"></a>
                            </div>
                            <div class="blog-cap">
                                <h3><a href="events.php">MEDAN FAKKA COMMUNITY ESPORTS</a></h3>
                                <a href="events.php" class="more-btn">Read more »</a>
                            </div>
                        </div>
                    </div>
