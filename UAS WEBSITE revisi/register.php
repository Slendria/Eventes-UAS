...
if (isset($_POST['submit'])) {
    ...
    if ($password == $cpassword) {
        ...
        if (!$result->num_rows > 0) {
            $sql = "INSERT INTO users (username, email, password, alamat, nama)
                    VALUES ('$username', '$email', '$password','$alamat','$nama')";
            $result = mysqli_query($conn, $sql);
            if ($result) {
...
<body>
    <div class="container">
        <form action="" method="POST" class="login-email">
            ...
            <div class="input-group">
           <button name="submit" class="btn">Register</button> <a href="login.php"> </a>
            </div>
