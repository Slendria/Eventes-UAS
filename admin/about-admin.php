                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-10">
                            <div class="single-caption mb-20">
                                <div class="caption-icon">
                                    ...
                                    echo "
                                    <tr>
                                    <td><a href ='edit_about.php?kode=$tampil[id_abt]'> Edit </a></td>
                                    ";
                                    $no++;
                                    }
                                    ?>
...
if(isset($_GET['id_abt'])){
   mysqli_query($conn, "DELETE from about where id_abt='$_GET[id_abt]'");

   echo "Data berhasil dihapus";
   echo"<meta http-equiv=refresh content=2; URL='about-admin.php'>";
